...
function buildBaseProcessPayload(config: LeStudioConfig, modeLabel: string, cameras: CameraMapping[]): BaseProcessPayload {
  ...
  return {
    ...
    robot_id: getString(cfg, "robot_id", "my_so101_follower_1"),
    teleop_id: getString(cfg, "teleop_id", "my_so101_leader_1"),
    ...
    left_robot_id: getString(cfg, "left_robot_id", "my_so101_follower_1"),
    right_robot_id: getString(cfg, "right_robot_id", "my_so101_follower_2"),
    left_teleop_id: getString(cfg, "left_teleop_id", "my_so101_leader_1"),
    right_teleop_id: getString(cfg, "right_teleop_id", "my_so101_leader_2"),
